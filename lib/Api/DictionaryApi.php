...
class DictionaryApi
{
    ...
    {
        list($response) = $this->listCategoriesWithHttpInfo($limit, $offset);
        return $response;
    }
     ...
     */
    public function listCategoriesAsync($limit = '10000', $offset = '0')
    {
        return $this->listCategoriesAsyncWithHttpInfo($limit, $offset)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    protected function listCategoriesRequest($limit = '10000', $offset = '0')
    {

        $resourcePath = '/supplier-api/v1/categories';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->listShippingClassesWithHttpInfo();
        return $response;
    }
    ...
    /**
     * Operation listShippingClassesAsync
     *
     * 
     *
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listShippingClassesAsync()
    {
        return $this->listShippingClassesAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation listShippingClassesAsyncWithHttpInfo
     *
     * 
     *
     *
    ...
    /**
     * Create request for operation 'listShippingClasses'
     *
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listShippingClassesRequest()
    {

        $resourcePath = '/supplier-api/v1/shipping-classes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
