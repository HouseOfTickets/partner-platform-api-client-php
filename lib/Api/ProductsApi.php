...
class ProductsApi
{
     ...
     * @return void
     */
    public function stopOffer($supplier_product_id, $body = null)
    {
        $this->stopOfferWithHttpInfo($supplier_product_id, $body);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function stopOfferWithHttpInfo($supplier_product_id, $body = null)
    {
        $returnType = '';
        $request = $this->stopOfferRequest($supplier_product_id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stopOfferAsync($supplier_product_id, $body = null)
    {
        return $this->stopOfferAsyncWithHttpInfo($supplier_product_id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function stopOfferAsyncWithHttpInfo($supplier_product_id, $body = null)
    {
        $returnType = '';
        $request = $this->stopOfferRequest($supplier_product_id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function stopOfferRequest($supplier_product_id, $body = null)
    {
        // verify the required parameter 'supplier_product_id' is set
        if ($supplier_product_id === null || (is_array($supplier_product_id) && count($supplier_product_id) === 0)) {
            throw new \InvalidArgumentException(
