...
/**
 * CountryCostDto Class Doc Comment
 *
 * @category Class
 * @package  Emesa\PartnerPlatform
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CountryCostDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CountryCostDto';
...
'nl' => 'getNl'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['be'] === null) {
            $invalidProperties[] = "'be' can't be null";
        }
        if ($this->container['de'] === null) {
            $invalidProperties[] = "'de' can't be null";
        }
        if ($this->container['nl'] === null) {
            $invalidProperties[] = "'nl' can't be null";
        }
